SELECT
    ...
    srp.project_title AS project_title,
    srp.name_of_funding_agency AS funding_agency_name,
    srp.duration_of_project AS project_duration,
...
WHERE
    srp.type = 'SPONSORED_RESEARCH_PROJECT'
    AND srp.year = $year;
