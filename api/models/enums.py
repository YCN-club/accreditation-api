...
class InstituteType(str, Enum):
    DEEMED_TO_BE_UNIVERSITY = "DEEMED_TO_BE_UNIVERSITY"
...
class InstituteOwnershipStatus(str, Enum):
    CENTRAL_GOVERNMENT = "CENTRAL_GOVERNMENT"
    STATE_GOVERNMENT = "STATE_GOVERNMENT"
    GRANT_IN_AID = "GRANT_IN_AID"
    SELF_FINANCING_TRUST = "SELF_FINANCING_TRUST"
    OTHER = "OTHER"


class ProgramAccreditationStatus(str, Enum):
    APPLYING_FIRST_TIME = "APPLYING_FIRST_TIME"
    GRANTED_ACCREDITATION_FOR_2_3_YEARS = "GRANTED_ACCREDITATION_FOR_2_3_YEARS"
    GRANTED_ACCREDITATION_FOR_5_6_YEARS = "GRANTED_ACCREDITATION_FOR_5_6_YEARS"
    NOT_ACCREDITED = "NOT_ACCREDITED"
    WITHDRAWN = "WITHDRAWN"
    NOT_ELIGIBLE_FOR_ACCREDITATION = "NOT_ELIGIBLE_FOR_ACCREDITATION"
    ELIGIBLE_BUT_NOT_APPLIED = "ELIGIBLE_BUT_NOT_APPLIED"
